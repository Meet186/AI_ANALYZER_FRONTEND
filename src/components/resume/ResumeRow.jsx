...
export function ResumeRow({ resume }) {
  ...
  return (
    <Card
      ...
      className="cursor-pointer flex items-center gap-4 hover:shadow-hover transition-all"
    >
      <div className="h-12 w-12 rounded-2xl bg-[var(--accent-soft)] text-[var(--accent-strong)] flex items-center justify-center shrink-0 ring-1 ring-[var(--border)]">
        <FileText size={18} />
      </div>
