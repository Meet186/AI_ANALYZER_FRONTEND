...
export const Input = forwardRef(({ className, type = "text", ...props }, ref) => (
  <input
    ...
    type={type}
    className={cn(
      "h-10 w-full rounded-full border border-[var(--border)] bg-[var(--surface)] px-4 text-sm text-[var(--ink)] placeholder:text-[var(--ink-muted)] outline-none transition-colors shadow-sm focus:border-[var(--accent)]/50 focus:ring-2 focus:ring-[var(--accent)]/15 disabled:opacity-50",
      className
    )}
    {...props}
  />
