  ...
  return (
    <Card
      ...
      className={cn(
        ...
        accent && "text-white ring-1 ring-white/10"
      )}
    >
      <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-[radial-gradient(circle_at_top_right,rgba(255,255,255,0.18),transparent_32%)]" />
        ...
        <div className="space-y-2 min-w-0 flex-1">
          ...
          {delta != null && (
            <Badge
              ...
              className={cn(accent && "bg-white/10 text-white border border-white/10")}
            >
              {positive ? "+" : ""}
              {delta}%
            </Badge>
