...
export default function ResumeDetail() {
  ...
  async function runAnalyze() {
    if (analyzeRequestRef.current || analyze.isPending || !activeVersionId) return;
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="overflow-hidden border-[var(--border-strong)] bg-[var(--surface)]">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <CardDescription className="mt-0.5">
                  {analysis ? "Review the latest score or run a fresh pass." : "Score this version and get focused improvements."}
                </CardDescription>
              </div>
            </div>
            <VersionSwitcher
        ...
        {analyze.error && (
          <div className="mt-4 text-xs text-[var(--danger)] bg-[var(--danger-soft)] border border-[var(--danger-border)] rounded-xl px-3 py-2">
            {analyze.error.message}
          </div>
        )}
        {applyRewrites.data?.version && !analysis && !analyze.isPending && (
          <div className="mt-4 text-xs text-[var(--accent-strong)] bg-[var(--accent-soft)] rounded-xl px-3 py-2">
            A new version is ready. Run an analysis when you are ready to compare its score.
          </div>
        )}
      </Card>
