...
const ROW_BASE =
  ...
  "transition-[width,background-color,color,box-shadow,transform] duration-300 ease-[cubic-bezier(0.16,1,0.3,1)]";
      ...
      {({ isActive }) => (
        <div
          className={cn(
            ROW_BASE,
            isActive
              ? "bg-[linear-gradient(135deg,var(--accent)_0%,var(--accent-strong)_100%)] text-white shadow-[0_12px_28px_rgba(90,124,103,0.28)]"
              : "text-[var(--ink-muted)] hover:bg-[var(--surface-2)] hover:text-[var(--ink)] hover:translate-x-0.5",
          )}
        >
  ...
  return (
    <aside
      className={cn(
        ...
        "flex-col items-center justify-between py-5 rounded-[28px]",
        "bg-[var(--surface)]/80 border border-[var(--border)] backdrop-blur-xl shadow-card overflow-hidden",
    ...
    >
      <div className="flex flex-col items-center gap-6 w-full">
        ...
        >
          <div className="h-12 w-12 flex items-center justify-center shrink-0 rounded-2xl bg-[var(--accent-soft)] ring-1 ring-[var(--border)]">
            <AILogo />
          </div>
          <span
            className={cn(
