      ...
      >
        ...
        >
          ...
          <div className="text-white">
            ...
            >
              <Sparkles size={12} className="text-[#B8D8FF]" />
            ...
            >
              ...
              <span
                style={{
                  backgroundImage:
                    "linear-gradient(120deg, #B8D8FF 0%, #79B4F4 55%, #2474D8 100%)",
            ...
            >
              <Link
                to="/register"
                className="group relative inline-flex items-center gap-2 h-12 px-5 rounded-full font-semibold text-[14px] text-white shadow-[0_10px_30px_-8px_rgba(102,167,245,0.5)] transition-all hover:shadow-[0_14px_36px_-8px_rgba(102,167,245,0.7)] active:scale-[0.98]"
                style={{
                  background:
