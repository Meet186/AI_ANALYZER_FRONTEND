    ...
    <div className="space-y-3">
      {!file && (
        <div
          {...getRootProps()}
          className={cn(
            "rounded-3xl border border-dashed cursor-pointer transition-all duration-200 outline-none shadow-card",
            compact ? "p-6" : "p-10",
            isDragActive
        ...
        >
          <input {...getInputProps({ id: "resume-file", name: "resume-file" })} />
